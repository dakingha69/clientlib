...
var CurrencyNetwork = /** @class */ (function () {
    ...
    CurrencyNetwork.prototype.getGatedNetwork = function (gatewayAddress) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.provider.fetchEndpoint("gateways/" + gatewayAddress)];
                    case 1:
                        gateway = _a.sent();
    ...
    CurrencyNetwork.prototype.getGateway = function (networkAddress) {
        return __awaiter(this, void 0, void 0, function () {
            var gateways;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.provider.fetchEndpoint("/gateways")];
                    case 1:
                        gateways = _a.sent();
                        return [2 /*return*/, gateways.find(function (gateway) { return gateway.gatedNetworkAddress === networkAddress; })];
                }
            });
        });
    };
    CurrencyNetwork.prototype.getShieldedNetwork = function (shieldAddress) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.provider.fetchEndpoint("shields/" + shieldAddress)];
                    case 1:
                        shield = _a.sent();
    ...
    CurrencyNetwork.prototype.getShield = function (networkAddress) {
        return __awaiter(this, void 0, void 0, function () {
            var shields;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.provider.fetchEndpoint("/shields")];
                    case 1:
                        shields = _a.sent();
                        return [2 /*return*/, shields.find(function (shield) { return shield.networkAddress === networkAddress; })];
                }
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        networks = _a.sent();
                        return [2 /*return*/, networks.map(function (network) { return (__assign({}, network, { defaultInterestRate: utils.formatToAmount(network.defaultInterestRate, network.interestRateDecimals) })); })];
                }
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        networkInfo = _a.sent();
                        return [2 /*return*/, __assign({}, networkInfo, { defaultInterestRate: utils.formatToAmount(networkInfo.defaultInterestRate, networkInfo.interestRateDecimals) })];
                }
            });
        });
    };
     ...
     */
    CurrencyNetwork.prototype.getUserOverview = function (networkAddress, userAddress, options) {
                ...
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, {
                                ...
                                frozenBalance: utils.formatToAmount(overview.frozenBalance, networkDecimals),
                                ...
                                leftReceived: utils.formatToAmount(overview.leftReceived, networkDecimals),
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, networkAddresses.reduce(function (decimalsMap, networkAddress, i) {
                                var _a;
                                return (__assign({}, decimalsMap, (_a = {}, _a[networkAddress] = decimalsObjects[i], _a)));
                            }, {})];
                }
            });
        });
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            if (!(typeof decimalsCache[networkAddress].networkDecimals !== 'number' ||
                                typeof decimalsCache[networkAddress].interestRateDecimals !== 'number')) return [3 /*break*/, 3];
                        ...
                        case 2:
                            ...
                            if (typeof decimalsCache[networkAddress].interestRateDecimals !==
                                'number') {
                                decimalsCache[networkAddress].interestRateDecimals =
                                    fetchedDecimals.interestRateDecimals;
                            }
                            _a.label = 3;
                        case 3: return [2 /*return*/, decimalsCache[networkAddress]];
                        case 4:
                            error_1 = _a.sent();
