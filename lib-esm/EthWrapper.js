            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.provider.fetchEndpoint(utils.buildUrl(baseUrl, { type: type, fromBlock: fromBlock }))];
                    case 2:
                        events = _b.sent();
                        return [2 /*return*/, events.map(function (event) { return utils.formatEvent(event, ETH_DECIMALS, 0); })];
                }
            });
        });
    };
