...
import { AnyEvent, AnyEventRaw, DecimalsOptions, EventFilterOptions, ReconnectingWSOptions } from './typings';
/**
...
export declare class Event {
     ...
     */
    get<T>(networkAddress: string, filter?: EventFilterOptions, options?: {
     ...
     * @hidden
     */
    updateStream(reconnectingOptions?: ReconnectingWSOptions): Observable<any>;
    /**
