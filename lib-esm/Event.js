...
var Event = /** @class */ (function () {
     ...
     */
    Event.prototype.get = function (networkAddress, filter, options) {
        if (filter === void 0) { filter = {}; }
        if (options === void 0) { options = {}; }
        return __awaiter(this, void 0, void 0, function () {
            var baseUrl, _a, parameterUrl, _b, events, _c, networkDecimals, interestRateDecimals;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 2:
                        _b = _d.sent(), events = _b[0], _c = _b[1], networkDecimals = _c.networkDecimals, interestRateDecimals = _c.interestRateDecimals;
                        return [2 /*return*/, events.map(function (event) {
                                return utils.formatEvent(event, networkDecimals, interestRateDecimals);
                            })];
                }
            });
        });
    ...
    Event.prototype.getAll = function (filter) {
        if (filter === void 0) { filter = {}; }
        return __awaiter(this, void 0, void 0, function () {
            var endpoint, _a, parameterUrl, events;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.user.getAddress()];
                    case 1:
                        endpoint = _a + (_b.sent()) + "/events";
                        parameterUrl = utils.buildUrl(endpoint, filter);
     ...
     * @hidden
     */
    Event.prototype.updateStream = function (reconnectingOptions) {
        var _this = this;
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, rawEvents.map(function (event) {
                                if (event.networkAddress) {
                                    return utils.formatEvent(event, decimalsMap[event.networkAddress]
                                        .networkDecimals, decimalsMap[event.networkAddress]
                                        .interestRateDecimals);
                                }
                                if (event.tokenAddress) {
                                    return utils.formatEvent(event, decimalsMap[event.tokenAddress].networkDecimals, decimalsMap[event.tokenAddress]
                                        .interestRateDecimals);
                                }
                                if (event.exchangeAddress) {
                                    var _a = event, makerTokenAddress = _a.makerTokenAddress, takerTokenAddress = _a.takerTokenAddress;
                                    return utils.formatExchangeEvent(event, decimalsMap[makerTokenAddress].networkDecimals, decimalsMap[takerTokenAddress].networkDecimals);
                                }
                                return event;
                            })];
                }
