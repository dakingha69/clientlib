        ...
        .mergeMap(function(event) {
          if (event.hasOwnProperty('networkAddress')) {
            return _this.currencyNetwork
              ...
              .then(function(_a) {
                var networkDecimals = _a.networkDecimals,
                  interestRateDecimals = _a.interestRateDecimals
                return utils.formatEvent(
                  event,
                  networkDecimals,
                  interestRateDecimals
      ...
      return __generator(this, function(_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [
              2 /*return*/,
              rawEvents.map(function(event) {
                if (event.networkAddress) {
                  return utils.formatEvent(
                    event,
                    decimalsMap[event.networkAddress].networkDecimals,
                    decimalsMap[event.networkAddress].interestRateDecimals
                  )
                }
                if (event.tokenAddress) {
                  return utils.formatEvent(
                    event,
                    decimalsMap[event.tokenAddress].networkDecimals,
                    decimalsMap[event.tokenAddress].interestRateDecimals
                  )
                }
                if (event.exchangeAddress) {
                  var _a = event,
                    makerTokenAddress = _a.makerTokenAddress,
                    takerTokenAddress = _a.takerTokenAddress
      ...
      return __generator(this, function(_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [
              2 /*return*/,
              addresses.reduce(function(decimalsMap, network, i) {
