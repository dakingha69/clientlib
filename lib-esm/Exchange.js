...
var Exchange = /** @class */ (function () {
    ...
    Exchange.prototype.makeOrder = function (exchangeContractAddress, makerTokenAddress, takerTokenAddress, makerTokenValue, takerTokenValue, options) {
        if (options === void 0) { options = {}; }
        return __awaiter(this, void 0, void 0, function () {
            var makerTokenDecimals, takerTokenDecimals, _a, expirationUnixTimestampSec, _b, makerDecimals, takerDecimals, orderRaw, _c, orderWithFees, orderHash, ecSignature, signedOrderRaw;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 1:
                        _b = _d.sent(), makerDecimals = _b[0].networkDecimals, takerDecimals = _b[1].networkDecimals;
                        _c = {
                    ...
                    case 2:
                        orderRaw = (_c.maker = _d.sent(),
                            ...
                            _c.takerTokenAmount = utils.calcRaw(takerTokenValue, takerDecimals).toString(),
                            _c);
    ...
    Exchange.prototype.prepTakeOrder = function (signedOrder, fillTakerTokenValue, options) {
        if (options === void 0) { options = {}; }
        return __awaiter(this, void 0, void 0, function () {
            var exchangeContractAddress, maker, makerTokenAddress, takerTokenAddress, makerTokenAmount, takerTokenAmount, ecSignature, gasLimit, gasPrice, makerTokenDecimals, takerTokenDecimals, _a, makerDecimals, takerDecimals, _b, makerPathObj, takerPathObj, _c, _d, _e, _f, _g, _h, _j, orderAddresses, orderValues, _k, rawTx, ethFees, _l, _m;
            return __generator(this, function (_o) {
                switch (_o.label) {
                    ...
                    case 1:
                        _a = _o.sent(), makerDecimals = _a[0].networkDecimals, takerDecimals = _a[1].networkDecimals;
                        _d = (_c = Promise).all;
                        _e = this._getPathObj;
                        _f = [makerTokenAddress,
                            maker];
                        return [4 /*yield*/, this.user.getAddress()];
                    case 2:
                        _g = [
                            _e.apply(this, _f.concat([_o.sent(),
                        ...
                        return [4 /*yield*/, this.user.getAddress()];
                    case 3: return [4 /*yield*/, _d.apply(_c, [_g.concat([
                                _h.apply(this, _j.concat([_o.sent(),
                                    maker,
                                    fillTakerTokenValue,
                                    {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, this.user.getAddress()];
                    case 5: return [4 /*yield*/, _m.apply(_l, [_o.sent(),
                            exchangeContractAddress,
                            'Exchange',
                            'fillOrderTrustlines',
                            [
                                orderAddresses,
                                orderValues,
                                utils.convertToHexString(utils.calcRaw(fillTakerTokenValue, takerDecimals)),
                                makerPathObj.path,
                                takerPathObj.path,
                                ecSignature.v,
                                ecSignature.r,
    ...
    Exchange.prototype.prepCancelOrder = function (signedOrder, cancelTakerTokenValue, options) {
        if (options === void 0) { options = {}; }
        return __awaiter(this, void 0, void 0, function () {
            var exchangeContractAddress, takerTokenAddress, gasLimit, gasPrice, takerTokenDecimals, takerDecimals, orderAddresses, orderValues, _a, rawTx, ethFees, _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                    ...
                    case 2: return [4 /*yield*/, _c.apply(_b, [_d.sent(),
                            ...
                            [
                                orderAddresses,
                                orderValues,
                                utils.convertToHexString(utils.calcRaw(cancelTakerTokenValue, takerDecimals))
                            ],
                            {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        isNetwork = _a.sent();
                        if (isNetwork) {
                            return [2 /*return*/, this.payment.getTransferPathInfo(tokenAddress, from, to, value, {
    ...
    Exchange.prototype._formatOrderRaw = function (signedOrderRaw, makerDecimals, takerDecimals) {
        return __assign({}, signedOrderRaw, { availableMakerTokenAmount: utils.formatToAmount(signedOrderRaw.availableMakerTokenAmount, makerDecimals), availableTakerTokenAmount: utils.formatToAmount(signedOrderRaw.availableTakerTokenAmount, takerDecimals), cancelledMakerTokenAmount: utils.formatToAmount(signedOrderRaw.cancelledMakerTokenAmount, makerDecimals), cancelledTakerTokenAmount: utils.formatToAmount(signedOrderRaw.cancelledTakerTokenAmount, takerDecimals), filledMakerTokenAmount: utils.formatToAmount(signedOrderRaw.filledMakerTokenAmount, makerDecimals), filledTakerTokenAmount: utils.formatToAmount(signedOrderRaw.filledTakerTokenAmount, takerDecimals), hash: this._getOrderHashHex(signedOrderRaw), makerFee: utils.formatToAmount(signedOrderRaw.makerFee, makerDecimals), makerTokenAmount: utils.formatToAmount(signedOrderRaw.makerTokenAmount, makerDecimals), takerFee: utils.formatToAmount(signedOrderRaw.takerFee, takerDecimals), takerTokenAmount: utils.formatToAmount(signedOrderRaw.takerTokenAmount, takerDecimals) });
    };
    /**
