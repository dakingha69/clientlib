...
var TLNetwork = /** @class */ (function () {
    ...
    function TLNetwork(config) {
        ...
        var _a = config.protocol, protocol = _a === void 0 ? 'http' : _a, _b = config.host, host = _b === void 0 ? 'localhost' : _b, _c = config.port, port = _c === void 0 ? '' : _c, _d = config.path, path = _d === void 0 ? '' : _d, _e = config.wsProtocol, wsProtocol = _e === void 0 ? 'ws' : _e, relayApiUrl = config.relayApiUrl, relayWsApiUrl = config.relayWsApiUrl, web3Provider = config.web3Provider, identityFactoryAddress = config.identityFactoryAddress, identityImplementationAddress = config.identityImplementationAddress, _f = config.walletType, walletType = _f === void 0 ? WALLET_TYPE_ETHERS : _f;
        this.setProvider(new RelayProvider(relayApiUrl || utils.buildApiUrl(protocol, host, port, path), relayWsApiUrl || utils.buildApiUrl(wsProtocol, host, port, path)));
