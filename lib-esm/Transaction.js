        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        txInfos = _a.sent();
                        abi = new ethers.utils.Interface(TrustlinesContractsAbi[contractName].abi);
                        rawTx = {
                    ...
                    case 2:
                        ...
                        delegationFeesObject = utils.convertToDelegationFees(delegationFeesInternal);
                        rawTx.delegationFees = delegationFeesObject.raw;
                        rawTx.currencyNetworkOfFees = delegationFeesObject.currencyNetworkOfFees;
                        ethFees = new BigNumber(rawTx.gasLimit).multipliedBy(rawTx.gasPrice);
                        return [2 /*return*/, {
                ...
                switch (_a.label) {
                    ...
                    case 4:
                        decimals = (_a.sent())
                            .networkDecimals;
                        _a.label = 5;
                    case 5: return [2 /*return*/, utils.formatToDelegationFeesInternal(delegationFees, decimals, currencyNetworkOfFees)];
                }
            });
        });
    };
