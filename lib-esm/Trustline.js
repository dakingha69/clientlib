...
var Trustline = /** @class */ (function () {
            ...
            return __generator(this, function (_f) {
                switch (_f.label) {
                    ...
                    case 1:
                        ...
                        updateFuncArgs = [
                            counterpartyAddress,
                            utils.convertToHexString(utils.calcRaw(creditlineGiven, decimals.networkDecimals)),
                            utils.convertToHexString(utils.calcRaw(creditlineReceived, decimals.networkDecimals))
                        ];
                        ...
                        if (interestRateGiven !== undefined &&
                            ...
                            updateFuncArgs = updateFuncArgs.concat([
                                utils.convertToHexString(customInterests
    ...
    Trustline.prototype._formatTrustline = function (trustline, networkDecimals, interestDecimals) {
        return __assign({}, trustline, { balance: utils.formatToAmount(trustline.balance, networkDecimals), given: utils.formatToAmount(trustline.given, networkDecimals), interestRateGiven: utils.formatToAmount(trustline.interestRateGiven, interestDecimals), interestRateReceived: utils.formatToAmount(trustline.interestRateReceived, interestDecimals), leftGiven: utils.formatToAmount(trustline.leftGiven, networkDecimals), leftReceived: utils.formatToAmount(trustline.leftReceived, networkDecimals), received: utils.formatToAmount(trustline.received, networkDecimals) });
    };
    return Trustline;
}());
export { Trustline };
