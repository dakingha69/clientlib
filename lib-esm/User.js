...
var User = /** @class */ (function () {
     ...
     */
    User.prototype.encryptToSerializedKeystore = function (tlWalletData, password, progressCallback) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.wallet.encryptToSerializedKeystore(tlWalletData, typeof password === 'string' ? password : this.defaultPassword, typeof password === 'function' ? password : progressCallback)];
            });
        });
    };
    /**
     ...
     * @returns the wallet data. Can be used with `loadFrom`
     */
    User.prototype.recoverFromEncryptedKeystore = function (serializedEncryptedKeystore, password, progressCallback) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.wallet.recoverFromEncryptedKeystore(serializedEncryptedKeystore, password, progressCallback)];
            });
        });
    };
    /**
    ...
    User.prototype.requestEth = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.provider.postToEndpoint("request-ether", {
