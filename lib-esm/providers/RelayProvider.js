...
var RelayProvider = /** @class */ (function () {
    ...
    RelayProvider.prototype.fetchEndpoint = function (endpoint, options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                trimmedEndpoint = utils.trimUrl(endpoint);
                return [2 /*return*/, utils.fetchUrl(this.relayApiUrl + "/" + trimmedEndpoint, options)];
            });
        });
    };
     ...
     */
    RelayProvider.prototype.createWebsocketStream = function (endpoint, functionName, args, reconnectingOptions) {
        var trimmedEndpoint = utils.trimUrl(endpoint);
        return utils.websocketStream(this.relayWsApiUrl + "/" + trimmedEndpoint, functionName, args, reconnectingOptions);
    };
    /**
    ...
    RelayProvider.prototype.getMetaTxInfos = function (address) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.fetchEndpoint("/identities/" + address)];
                    case 1:
                        _a = _b.sent(), identity = _a.identity, nextNonce = _a.nextNonce, balance = _a.balance;
                        return [2 /*return*/, {
                                balance: new BigNumber(balance),
    ...
    RelayProvider.prototype.getMetaTxFees = function (metaTransaction) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.postToEndpoint("/meta-transaction-fees", {
    ...
    RelayProvider.prototype.sendSignedTransaction = function (signedTransaction) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.postToEndpoint("relay", {
     ...
     */
    RelayProvider.prototype.sendSignedMetaTransaction = function (signedMetaTransaction) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.postToEndpoint('relay-meta-transaction', {
