...
export declare type AnyNetworkEvent =
  | NetworkTransferEvent
  | NetworkTrustlineEvent
  | NetworkTrustlineCancelEvent
export declare type AnyNetworkEventRaw =
...
export declare type AnyExchangeEventRaw =
...
export declare type AnyEvent =
  ...
  | AnyTokenEvent
  | AnyExchangeEvent
export declare type AnyEventRaw =
  | AnyNetworkEventRaw
  | AnyTokenEventRaw
  | AnyExchangeEventRaw
export declare type AmountEventRaw =
  | NetworkTransferEventRaw
  | TokenAmountEventRaw
