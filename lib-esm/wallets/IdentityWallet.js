      ...
      return __generator(this, function(_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [
              2 /*return*/,
              utils.formatToAmount(utils.calcRaw(balance, 18), 18)
            ]
        }
      })
    })
  ...
  IdentityWallet.prototype.deployIdentity = function() {
    return __awaiter(this, void 0, void 0, function() {
      ...
      return __generator(this, function(_a) {
        switch (_a.label) {
          case 0:
            messageHash = ethersUtils.solidityKeccak256(
      ...
      return __generator(this, function(_a) {
        switch (_a.label) {
          case 0:
            return [
              4 /*yield*/,
              WalletFromEthers.fromEncryptedJson(
                serializedEncryptedKeystore,
                password,
      ...
      return __generator(this, function(_b) {
        switch (_b.label) {
          case 0:
            ...
            metaTransactionHash = ethersUtils.solidityKeccak256(types, values)
            _a = metaTransaction
      ...
      return __generator(this, function(_c) {
        switch (_c.label) {
          case 0:
            ...
            signingKey = new ethersUtils.SigningKey(
              this.walletFromEthers.privateKey
            )
            _b = (_a = ethersUtils).joinSignature
...
export function calculateIdentityAddress(factoryAddress, ownerAddress) {
  ...
  var initCodeHash = ethersUtils.solidityKeccak256(['bytes'], [initCode])
