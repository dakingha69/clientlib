...
import { EXPECTED_VERSIONS, verifyWalletData, WALLET_TYPE_IDENTITY } from './TLWallet';
    ...
    IdentityWallet.prototype.deployIdentity = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        messageHash = ethersUtils.solidityKeccak256(['bytes1', 'bytes1', 'address', 'address'], [
                            '0x19',
                            '0x00',
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        signingKey = new ethersUtils.SigningKey(this.walletFromEthers.privateKey);
