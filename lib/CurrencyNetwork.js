  ...
  CurrencyNetwork.prototype.getGateway = function(networkAddress) {
    return __awaiter(this, void 0, void 0, function() {
      ...
      return __generator(this, function(_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, this.provider.fetchEndpoint('/gateways')]
          case 1:
            gateways = _a.sent()
            return [
              2 /*return*/,
              gateways.find(function(gateway) {
                return gateway.gatedNetworkAddress === networkAddress
              })
            ]
        }
      })
  ...
  CurrencyNetwork.prototype.getShield = function(networkAddress) {
    return __awaiter(this, void 0, void 0, function() {
      ...
      return __generator(this, function(_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, this.provider.fetchEndpoint('/shields')]
          case 1:
            shields = _a.sent()
            return [
              2 /*return*/,
              shields.find(function(shield) {
                return shield.networkAddress === networkAddress
              })
            ]
        }
      })
            ...
            return [
              ...
              networks.map(function(network) {
                return __assign({}, network, {
                  defaultInterestRate: utils_1.default.formatToAmount(
          ...
          case 2:
            ...
            return [
              2 /*return*/,
              {
                ...
                frozenBalance: utils_1.default.formatToAmount(
                  overview.frozenBalance,
                  networkDecimals
                ),
                given: utils_1.default.formatToAmount(
                  overview.given,
                  networkDecimals
                ),
