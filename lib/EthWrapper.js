      ...
      return __generator(this, function(_b) {
        switch (_b.label) {
          ...
          case 2:
            ...
            return [
              2 /*return*/,
              utils_1.default.formatToAmount(balance, ETH_DECIMALS)
            ]
        }
      })
    })
              ...
              _c.apply(_b, [
                ...
                [
                  ...
                  utils_1.default.convertToHexString(
                    utils_1.default.calcRaw(value, ETH_DECIMALS)
                  )
                ],
                {
                  gasLimit: gasPrice
          ...
          case 1:
            ...
            return [
              ...
              this.provider.fetchEndpoint(
                utils_1.default.buildUrl(baseUrl, {
                  type: type,
                  fromBlock: fromBlock
                })
              )
          ...
          case 2:
            ...
            return [
              ...
              events.map(function(event) {
                return utils_1.default.formatEvent(event, ETH_DECIMALS, 0)
              })
            ]
        }
      })
