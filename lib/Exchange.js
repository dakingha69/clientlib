...
var Exchange = /** @class */ (function() {
      ...
      return __generator(this, function(_d) {
        switch (_d.label) {
          ...
          case 2:
            ...
            (_c.makerFee = '0'),
            (_c.makerTokenAddress = ethers_1.ethers.utils.getAddress(
              makerTokenAddress
            )),
            ...
            (_c.takerFee = '0'),
            (_c.takerTokenAddress = ethers_1.ethers.utils.getAddress(
              takerTokenAddress
            )),
            (_c.takerTokenAmount = utils_1.default
              .calcRaw(takerTokenValue, takerDecimals)
              .toString()),
            _c)
              ...
              _m.apply(_l, [
                ...
                [
                  ...
                  utils_1.default.convertToHexString(
                    utils_1.default.calcRaw(fillTakerTokenValue, takerDecimals)
                  ),
                  makerPathObj.path,
                  takerPathObj.path,
                  ecSignature.v,
  ...
  Exchange.prototype._getOrderValues = function(order) {
    return [
      utils_1.default.convertToHexString(
        new bignumber_js_1.BigNumber(order.makerTokenAmount.raw)
      ),
      utils_1.default.convertToHexString(
        new bignumber_js_1.BigNumber(order.takerTokenAmount.raw)
      ),
      utils_1.default.convertToHexString(new bignumber_js_1.BigNumber('0')),
      utils_1.default.convertToHexString(new bignumber_js_1.BigNumber('0')),
      utils_1.default.convertToHexString(
        new bignumber_js_1.BigNumber(order.expirationUnixTimestampSec)
      ),
      utils_1.default.convertToHexString(
        new bignumber_js_1.BigNumber(order.salt)
      )
    ]
  }
  /**
  ...
  Exchange.prototype._formatOrderRaw = function(
    ...
    return __assign({}, signedOrderRaw, {
      availableMakerTokenAmount: utils_1.default.formatToAmount(
        signedOrderRaw.availableMakerTokenAmount,
        makerDecimals
      ),
      availableTakerTokenAmount: utils_1.default.formatToAmount(
        signedOrderRaw.availableTakerTokenAmount,
        takerDecimals
      ),
      cancelledMakerTokenAmount: utils_1.default.formatToAmount(
        signedOrderRaw.cancelledMakerTokenAmount,
        makerDecimals
      ),
      cancelledTakerTokenAmount: utils_1.default.formatToAmount(
        signedOrderRaw.cancelledTakerTokenAmount,
        takerDecimals
      ),
      filledMakerTokenAmount: utils_1.default.formatToAmount(
        signedOrderRaw.filledMakerTokenAmount,
        makerDecimals
      ),
      filledTakerTokenAmount: utils_1.default.formatToAmount(
        signedOrderRaw.filledTakerTokenAmount,
        takerDecimals
      ),
      hash: this._getOrderHashHex(signedOrderRaw),
      makerFee: utils_1.default.formatToAmount(
        signedOrderRaw.makerFee,
        makerDecimals
      ),
      makerTokenAmount: utils_1.default.formatToAmount(
        signedOrderRaw.makerTokenAmount,
        makerDecimals
      ),
      takerFee: utils_1.default.formatToAmount(
        signedOrderRaw.takerFee,
        takerDecimals
      ),
      takerTokenAmount: utils_1.default.formatToAmount(
