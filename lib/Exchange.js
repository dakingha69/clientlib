                ...
                switch (_d.label) {
                    ...
                    case 2:
                        orderRaw = (_c.maker = _d.sent(),
                            _c.makerFee = '0',
                            _c.makerTokenAddress = ethers_1.ethers.utils.getAddress(makerTokenAddress),
                            _c.makerTokenAmount = utils_1.default
                                .calcRaw(makerTokenValue, makerDecimals)
                                .toString(),
                            _c.salt = Math.floor(Math.random() * 1000000000).toString(),
                            _c.taker = ZERO_ADDRESS,
                            _c.takerFee = '0',
                            _c.takerTokenAddress = ethers_1.ethers.utils.getAddress(takerTokenAddress),
                            _c.takerTokenAmount = utils_1.default.calcRaw(takerTokenValue, takerDecimals).toString(),
                            _c);
                    ...
                    case 5: return [4 /*yield*/, _m.apply(_l, [_o.sent(),
                            ...
                            ],
                            {
                                gasLimit: gasLimit
                                    ...
                                    : new bignumber_js_1.BigNumber(DEFAULT_GAS_LIMIT_TAKE_ORDER)
                                        .multipliedBy(1.5)
                                        .integerValue(),
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, {
                                feePayer: typings_1.FeePayer.Sender,
                                isNetwork: false,
