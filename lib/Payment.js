...
var Payment = /** @class */ (function() {
          ...
          case 4:
            return [
              ...
              _f.apply(_e, [
                ...
                feePayer === typings_1.FeePayer.Receiver
                ...
                [
                  ...
                  utils_1.default.convertToHexString(
                    new bignumber_js_1.BigNumber(maxFees.raw)
                  ),
                  path,
                  extraData || '0x'
                ],
          ...
          case 1:
            return [
              ...
              _c.apply(_b, [
                _d.sent(),
                receiverAddress,
                utils_1.default.calcRaw(value, 18),
                {
                  gasLimit: gasLimit
                    ? new bignumber_js_1.BigNumber(gasLimit)
                    : undefined,
   ...
   */
  Payment.prototype.getTransferPathInfo = function(
    networkAddress,
    senderAddress,
    receiverAddress,
    value,
        ...
        switch (_b.label) {
          case 0:
            ;(networkDecimals = options.networkDecimals),
              ...
              (feePayerOption = options.feePayer),
              (extraData = options.extraData)
            return [
              4 /*yield*/,
              this.currencyNetwork.getDecimals(networkAddress, {
   ...
   */
  Payment.prototype.createRequest = function(
    networkAddress,
    amount,
    subject,
    customBase
    ...
    return __awaiter(this, void 0, void 0, function() {
      ...
      return __generator(this, function(_b) {
        switch (_b.label) {
          case 0:
            _a = ['paymentrequest', networkAddress]
            return [4 /*yield*/, this.user.getAddress()]
          case 1:
            params = _a.concat([_b.sent(), amount, subject])
            return [
              2 /*return*/,
              utils_1.default.createLink(params, customBase)
            ]
        }
      })
    })
   ...
   */
  Payment.prototype.getMaxAmountAndPathInNetwork = function(
    networkAddress,
    receiverAddress
  ) {
    return __awaiter(this, void 0, void 0, function() {
      ...
      return __generator(this, function(_a) {
        switch (_a.label) {
          ...
          case 2:
            ...
            return [
              4 /*yield*/,
              this.provider.postToEndpoint(endpoint, {
                from: userAddress,
                to: receiverAddress
              })
            ]
          case 3:
            ...
            return [
              2 /*return*/,
              {
                amount: utils_1.default.formatToAmount(
                  result.capacity,
                  networkDecimals
                ),
                path: result.path
