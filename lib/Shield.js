          ...
          case 5:
            ...
            funcArgs = [
              proof.map(function(p) {
                return utils_1.default.convertToHexString(p)
              }),
              inputs.map(function(i) {
                return utils_1.default.convertToHexString(i)
              }),
              utils_1.default.convertToHexString(
                utils_1.default.calcRaw(mintValue, decimals.networkDecimals)
              ),
              commitment,
              path
            ]
        ...
        switch (_g.label) {
          ...
          case 5:
            ...
            funcArgs = [
              ...
              nullifier,
              utils_1.default.convertToHexString(
                utils_1.default.calcRaw(burnValue, decimals.networkDecimals)
              ),
              path
            ]
            _f = (_e = this.transaction).prepareContractTransaction
