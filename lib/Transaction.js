...
var Transaction = /** @class */ (function() {
   ...
   */
  Transaction.prototype.prepareContractTransaction = function(
    userAddress,
    contractAddress,
    contractName,
    functionName,
    ...
    return __awaiter(this, void 0, void 0, function() {
      ...
      return __generator(this, function(_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, this.signer.getTxInfos(userAddress)]
          case 1:
            txInfos = _a.sent()
            abi = new ethers_1.ethers.utils.Interface(
              contracts_json_1.default[contractName].abi
            )
            rawTx = {
              data: abi.functions[functionName].encode(args),
              from: userAddress,
              gasLimit:
                options.gasLimit || new bignumber_js_1.BigNumber(600000),
          ...
          case 2:
            ...
            delegationFeesObject = utils_1.default.convertToDelegationFees(
              delegationFeesInternal
            )
            rawTx.delegationFees = delegationFeesObject.raw
            rawTx.currencyNetworkOfFees =
              delegationFeesObject.currencyNetworkOfFees
            ethFees = new bignumber_js_1.BigNumber(rawTx.gasLimit).multipliedBy(
              rawTx.gasPrice
            )
            return [
              2 /*return*/,
              {
                ethFees: utils_1.default.formatToAmountInternal(
                  ethFees,
                  ETH_DECIMALS
                ),
   ...
   */
  Transaction.prototype.prepareValueTransaction = function(
    senderAddress,
    receiverAddress,
    rawValue,
    options
    ...
    return __awaiter(this, void 0, void 0, function() {
      ...
      return __generator(this, function(_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, this.signer.getTxInfos(senderAddress)]
          case 1:
            txInfos = _a.sent()
            rawTx = {
              from: senderAddress,
      ...
      return __generator(this, function(_a) {
        switch (_a.label) {
          case 0:
            ...
            return [3 /*break*/, 3]
          case 1:
            return [4 /*yield*/, this.signer.getMetaTxFees(rawTx)]
          case 2:
          ...
          case 3:
            ...
            return [
              4 /*yield*/,
              this.currencyNetwork.getDecimals(currencyNetworkOfFees)
            ]
          case 4:
            decimals = _a.sent().networkDecimals
            _a.label = 5
          case 5:
            return [
              2 /*return*/,
              utils_1.default.formatToDelegationFeesInternal(
                delegationFees,
                decimals,
