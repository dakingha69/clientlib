...
var Transaction = /** @class */ (function () {
     ...
     */
    Transaction.prototype.prepareContractTransaction = function (userAddress, contractAddress, contractName, functionName, args, options) {
        if (options === void 0) { options = {}; }
        return __awaiter(this, void 0, void 0, function () {
            var txInfos, abi, rawTx, delegationFeesInternal, delegationFeesObject, ethFees;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.signer.getTxInfos(userAddress)];
                    case 1:
                        txInfos = _a.sent();
                        abi = new ethers_1.ethers.utils.Interface(contracts_json_1.default[contractName].abi);
                        rawTx = {
                        ...
                        return [4 /*yield*/, this.getDelegationFees(rawTx, options)];
                    case 2:
                        delegationFeesInternal = _a.sent();
                        delegationFeesObject = utils_1.default.convertToDelegationFees(delegationFeesInternal);
                        rawTx.delegationFees = delegationFeesObject.raw;
                        rawTx.currencyNetworkOfFees = delegationFeesObject.currencyNetworkOfFees;
                        ethFees = new bignumber_js_1.BigNumber(rawTx.gasLimit).multipliedBy(rawTx.gasPrice);
                        return [2 /*return*/, {
     ...
     */
    Transaction.prototype.prepareValueTransaction = function (senderAddress, receiverAddress, rawValue, options) {
        if (options === void 0) { options = {}; }
        return __awaiter(this, void 0, void 0, function () {
            var txInfos, rawTx, delegationFeesInternal, delegationFeesObject, ethFees;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.signer.getTxInfos(senderAddress)];
                    case 1:
                        txInfos = _a.sent();
                        rawTx = {
                            from: senderAddress,
     ...
     * @returns An ethereum transaction object containing and the estimated transaction fees in ETH.
     */
    Transaction.prototype.getDelegationFees = function (rawTx, options) {
        if (options === void 0) { options = {}; }
        return __awaiter(this, void 0, void 0, function () {
            var delegationFees, currencyNetworkOfFees, metaTransactionFees, decimals;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(options.delegationFees && options.currencyNetworkOfFees)) return [3 /*break*/, 1];
                        delegationFees = options.delegationFees;
                        currencyNetworkOfFees = options.currencyNetworkOfFees;
                        return [3 /*break*/, 3];
                    case 1: return [4 /*yield*/, this.signer.getMetaTxFees(rawTx)];
                    case 2:
                        metaTransactionFees = _a.sent();
                        delegationFees = metaTransactionFees.delegationFees;
                        currencyNetworkOfFees = metaTransactionFees.currencyNetworkOfFees;
                        _a.label = 3;
                    case 3:
                        decimals = 0;
                        if (!(delegationFees !== '0' && currencyNetworkOfFees !== '')) return [3 /*break*/, 5];
                        return [4 /*yield*/, this.currencyNetwork.getDecimals(currencyNetworkOfFees)];
                    case 4:
                        decimals = (_a.sent())
                            .networkDecimals;
                        _a.label = 5;
                    case 5: return [2 /*return*/, utils_1.default.formatToDelegationFeesInternal(delegationFees, decimals, currencyNetworkOfFees)];
                }
            });
        });
    };
