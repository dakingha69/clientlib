...
import { ClosePathObject, CloseTxObject, DecimalsOptions, EventFilterOptions, NetworkEvent, NetworkTrustlineEvent, PaymentOptions, RawTxObject, TrustlineObject, TrustlineUpdateOptions, TxObject, TxOptions } from './typings';
/**
...
export declare class Trustline {
     ...
     */
    get(networkAddress: string, counterpartyAddress: string, options?: {
        decimalsOptions?: DecimalsOptions;
    }): Promise<TrustlineObject>;
    /**
     ...
     * @param filter Event filter object. See `EventFilterOptions` for more information.
     */
    getTrustlineUpdateCancels(networkAddress: string, filter?: EventFilterOptions): Promise<NetworkEvent[]>;
    /**
