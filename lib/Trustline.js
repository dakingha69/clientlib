...
var MAX_UINT_64 = new bignumber_js_1.default('1844674407370955200')
/**
...
var Trustline = /** @class */ (function() {
   ...
   */
  Trustline.prototype.prepareUpdate = function(
    networkAddress,
    counterpartyAddress,
    creditlineGiven,
    creditlineReceived,
      ...
      return __generator(this, function(_f) {
        switch (_f.label) {
          case 0:
            ...
            ;(interestRateGiven = options.interestRateGiven),
              (interestRateReceived = options.interestRateReceived),
              (networkDecimals = options.networkDecimals),
              (interestRateDecimals = options.interestRateDecimals),
          ...
          case 1:
            ;(_a = _f.sent()),
              (decimals = _a[0]),
              (_b = _a[1]),
              (customInterests = _b.customInterests),
              (defaultInterestRate = _b.defaultInterestRate)
            updateFuncName = 'updateCreditlimits'
            updateFuncArgs = [
              counterpartyAddress,
              utils_1.default.convertToHexString(
                utils_1.default.calcRaw(
                  creditlineGiven,
              ...
              _e.apply(_d, [
                ...
                updateFuncArgs,
                {
                  gasLimit: gasLimit
                    ...
                    : undefined,
                  gasPrice: gasPrice
                    ? new bignumber_js_1.default(gasPrice)
                    : undefined
                }
              ])
            ]
          case 3:
            ;(_c = _f.sent()),
              (rawTx = _c.rawTx),
              (ethFees = _c.ethFees),
              (delegationFees = _c.delegationFees)
            return [
              2 /*return*/,
              {
                ethFees: utils_1.default.convertToAmount(ethFees),
                delegationFees: utils_1.default.convertToDelegationFees(
                  delegationFees
                ),
                rawTx: rawTx
              }
   ...
   * @param options.gasPrice Custom gas price.
   */
  Trustline.prototype.prepareAccept = function(
    networkAddress,
    initiatorAddress,
    creditlineGiven,
    creditlineReceived,
   ...
   * @param options.gasPrice Custom gas price.
   */
  Trustline.prototype.prepareCancelTrustlineUpdate = function(
    networkAddress,
    counterpartyAddress,
    options
  ) {
  ...
  Trustline.prototype.prepareOpenCollateralized = function(
    gatewayAddress,
    collateralValue,
    options
  ) {
      ...
      return __generator(this, function(_d) {
        switch (_d.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.currencyNetwork.getGatedNetwork(gatewayAddress)
            ]
          case 1:
            decimals = _d.sent().decimals
            funcName = 'openCollateralizedTrustline'
            funcArgs = [utils_1.default.convertToHexString(MAX_UINT_64)]
            collateralRaw = utils_1.default.convertToHexString(
              utils_1.default.calcRaw(collateralValue, 18)
            )
            _c = (_b = this.transaction).prepareContractTransaction
            return [4 /*yield*/, this.user.getAddress()]
          case 2:
  ...
  Trustline.prototype.prepareClaim = function(
    gatewayAddress,
    claimValue,
    options
  ) {
      ...
      return __generator(this, function(_d) {
        switch (_d.label) {
          ...
          case 1:
            ...
            funcArgs = [
              utils_1.default.convertToHexString(
                utils_1.default.calcRaw(claimValue, decimals)
              )
            ]
            _c = (_b = this.transaction).prepareContractTransaction
            return [4 /*yield*/, this.user.getAddress()]
  ...
  Trustline.prototype.preparePayOff = function(
    gatewayAddress,
    payOffValue,
    options
  ) {
      ...
      return __generator(this, function(_d) {
        switch (_d.label) {
          ...
          case 1:
            ...
            funcArgs = [
              utils_1.default.convertToHexString(
                utils_1.default.calcRaw(payOffValue, decimals)
              )
            ]
            _c = (_b = this.transaction).prepareContractTransaction
            return [4 /*yield*/, this.user.getAddress()]
    ...
    return __awaiter(this, void 0, void 0, function() {
      ...
      return __generator(this, function(_b) {
        switch (_b.label) {
          ...
          case 2:
            trustlines = _b.sent()
            networkAddressesOfTrustlines = new Set(
              trustlines.map(function(trustline) {
                return trustline.currencyNetwork
              })
            )
            return [
              4 /*yield*/,
              this.currencyNetwork.getDecimalsMap(
        ...
        switch (_d.label) {
          ...
          case 2:
            ;(_b = _d.sent()),
              (trustlines = _b[0]),
              (_c = _b[1]),
              (networkDecimals = _c.networkDecimals),
              (interestRateDecimals = _c.interestRateDecimals)
            return [
              2 /*return*/,
              trustlines.map(function(trustline) {
                return _this._formatTrustline(
   ...
   */
  Trustline.prototype.get = function(
    networkAddress,
    counterpartyAddress,
    options
  ) {
  ...
  Trustline.prototype.getRequests = function(networkAddress, filter) {
    ...
    return this.event.get(
      networkAddress,
      __assign({}, filter, { type: 'TrustlineUpdateRequest' })
    )
  }
  /**
   ...
   * @param filter Event filter object. See `EventFilterOptions` for more information.
   */
  Trustline.prototype.getTrustlineUpdateCancels = function(
    networkAddress,
    filter
  ) {
    if (filter === void 0) {
    ...
    return this.event.get(
      networkAddress,
      __assign({}, filter, { type: 'TrustlineUpdateCancel' })
    )
  }
  /**
  ...
  Trustline.prototype.getUpdates = function(networkAddress, filter) {
    ...
    return this.event.get(
      networkAddress,
      __assign({}, filter, { type: 'TrustlineUpdate' })
    )
  }
  /**
   ...
   */
  Trustline.prototype.prepareClose = function(
    networkAddress,
    counterpartyAddress,
    options
  ) {
          ...
          case 3:
            ...
            if (value.raw === '0') {
              ...
              closeFuncArgs = [
                counterpartyAddress,
                utils_1.default.convertToHexString(
                  new bignumber_js_1.default(maxFees.raw)
                ),
                path
              ]
            }
   ...
   */
  Trustline.prototype.getClosePath = function(
    networkAddress,
    senderAddress,
    counterpartyAddress,
    options
        ...
        switch (_b.label) {
          case 0:
            ;(networkDecimals = options.networkDecimals),
              ...
              (maximumFees = options.maximumFees)
            return [
              4 /*yield*/,
              this.currencyNetwork.getDecimals(networkAddress, {
                networkDecimals: networkDecimals
          ...
          case 2:
            ...
            return [
              ...
              {
                feePayer: feePayer,
                maxFees: utils_1.default.formatToAmount(
                  fees,
                  decimals.networkDecimals
                ),
                path: path,
                value: utils_1.default.formatToAmount(
                  value,
                  decimals.networkDecimals
                )
              }
   ...
   */
  Trustline.prototype._formatTrustline = function(
    trustline,
    networkDecimals,
    interestDecimals
  ) {
    return __assign({}, trustline, {
      balance: utils_1.default.formatToAmount(
        trustline.balance,
        networkDecimals
      ),
      given: utils_1.default.formatToAmount(trustline.given, networkDecimals),
      interestRateGiven: utils_1.default.formatToAmount(
        trustline.interestRateGiven,
        interestDecimals
      ),
      interestRateReceived: utils_1.default.formatToAmount(
        trustline.interestRateReceived,
        interestDecimals
      ),
      leftGiven: utils_1.default.formatToAmount(
        trustline.leftGiven,
        networkDecimals
      ),
      leftReceived: utils_1.default.formatToAmount(
        trustline.leftReceived,
        networkDecimals
      ),
      received: utils_1.default.formatToAmount(
        trustline.received,
        networkDecimals
      )
    })
