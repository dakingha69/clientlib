          ...
          case 0:
            ...
            return [
              ...
              this.signer.sendTransaction({
                data: rawTx.data,
                gasLimit: ethers_1.ethers.utils.bigNumberify(
                  rawTx.gasLimit instanceof bignumber_js_1.BigNumber
                    ? rawTx.gasLimit.toString()
                    : rawTx.gasLimit
                ),
                gasPrice: ethers_1.ethers.utils.bigNumberify(
                ...
                nonce: rawTx.nonce,
                to: rawTx.to,
                value: ethers_1.ethers.utils.bigNumberify(
      ...
      return __generator(this, function(_b) {
        switch (_b.label) {
          ...
          case 1:
            ...
            ;(_a = ethers_1.ethers.utils.splitSignature(flatSignature)),
              (r = _a.r),
              (s = _a.s),
              (v = _a.v)
            return [
  ...
  Web3Signer.prototype.getTxInfos = function(userAddress) {
    return __awaiter(this, void 0, void 0, function() {
      ...
      return __generator(this, function(_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, this.web3Provider.getBalance(userAddress)]
          case 1:
            balanceString = _a.sent().toString()
            return [
              4 /*yield*/,
              this.web3Provider.getTransactionCount(userAddress)
            ]
          case 2:
            nonce = _a.sent()
          ...
          case 3:
            ...
            gasPrice = new bignumber_js_1.BigNumber(gasPriceString)
            balance = new bignumber_js_1.BigNumber(balanceString)
            return [
              2 /*return*/,
              { balance: balance, gasPrice: gasPrice, nonce: nonce }
            ]
        }
      })
    })
