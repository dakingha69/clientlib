...
import { Amount, AmountInternal, AnyExchangeEvent, AnyExchangeEventRaw, DelegationFeesInternal, DelegationFeesObject, ReconnectingWSOptions } from './typings';
/**
 ...
 */
export declare const websocketStream: (url: string, functionName: string, args: object, reconnectingOptions?: ReconnectingWSOptions) => Observable<any>;
/**
 * Encodes URI components and returns a URL.
 * @param baseUrl base URL
 * @param params (optional) parameters for queries
 */
export declare const buildUrl: (baseUrl: string, params?: object | any[]) => string;
/**
 ...
 */
export declare const formatToDelegationFeesInternal: (raw: string | number | BigNumber, decimals: number, currencyNetworkOfFees: string) => DelegationFeesInternal;
/**
 * Formats number into an AmountInternal object which is intended for internal use.
 * @param delegationFees DelegationFeesInternal object.
 */
export declare const convertToDelegationFees: (delegationFees: DelegationFeesInternal) => DelegationFeesObject;
/**
...
declare const _default: {
    ...
    formatToDelegationFeesInternal: (raw: string | number | BigNumber, decimals: number, currencyNetworkOfFees: string) => DelegationFeesInternal;
