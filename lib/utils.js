...
var reconnecting_websocket_1 = __importDefault(
...
exports.fetchUrl = function(url, options) {
  return __awaiter(_this, void 0, void 0, function() {
    ...
    return __generator(this, function(_b) {
      switch (_b.label) {
        case 0:
          return [4 /*yield*/, axios_1.default(__assign({ url: url }, options))]
        case 1:
 ...
 */
exports.websocketStream = function(
  url,
  functionName,
  args,
  reconnectingOptions
  ...
  return Observable_1.Observable.create(function(observer) {
    var options = __assign(
      {
        WebSocket: global.WebSocket ? undefined : ws_1.default,
 ...
 */
exports.formatToDelegationFeesInternal = function(
  raw,
  decimals,
...
exports.formatEvent = function(event, networkDecimals, interestRateDecimals) {
  ...
  for (var _i = 0, keys_1 = keys; _i < keys_1.length; _i++) {
    var key = keys_1[_i]
    if (event[key]) {
      event[key] = exports.formatToAmount(
        event[key],
 ...
 */
exports.formatExchangeEvent = function(
  exchangeEvent,
  makerDecimals,
  takerDecimals
) {
  if (exchangeEvent.type === 'LogFill') {
    ...
    return __assign({}, fillEventRaw, {
      filledMakerAmount: exports.formatToAmount(
        fillEventRaw.filledMakerAmount,
        makerDecimals
      ),
      filledTakerAmount: exports.formatToAmount(
    ...
    return __assign({}, cancelEventRaw, {
      cancelledMakerAmount: exports.formatToAmount(
        cancelEventRaw.cancelledMakerAmount,
        makerDecimals
      ),
      cancelledTakerAmount: exports.formatToAmount(
