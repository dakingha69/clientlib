...
var EthersWallet = /** @class */ (function() {
   ...
   */
  EthersWallet.prototype.encryptToSerializedKeystore = function(
    walletData,
    password,
    progressCallback
  ) {
    ...
    return __awaiter(this, void 0, void 0, function() {
      return __generator(this, function(_a) {
        TLWallet_1.verifyWalletData(
          walletData,
          TLWallet_1.WALLET_TYPE_ETHERS,
          TLWallet_1.EXPECTED_VERSIONS
        )
        this.walletFromEthers = WalletFromEthers_1.WalletFromEthers.fromWalletData(
          walletData
        )
        return [2 /*return*/]
      })
   ...
   */
  EthersWallet.prototype.recoverFromEncryptedKeystore = function(
  ...
  EthersWallet.prototype.signMsgHash = function(msgHash) {
    return __awaiter(this, void 0, void 0, function() {
      ...
      return __generator(this, function(_a) {
        ...
        if (!ethers_1.utils.isHexString(msgHash)) {
          throw new Error('Message hash is not a valid hex string.')
        }
        msgHashBytes = ethers_1.utils.arrayify(msgHash)
      ...
      return __generator(this, function(_b) {
        switch (_b.label) {
          ...
          case 1:
            ...
            ;(_a = ethers_1.utils.splitSignature(flatFormatSignature)),
              (r = _a.r),
              (s = _a.s),
              (v = _a.v)
            return [
      ...
      return __generator(this, function(_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.walletFromEthers.sign({
                data: rawTx.data,
                gasLimit: ethers_1.utils.bigNumberify(
                  rawTx.gasLimit instanceof bignumber_js_1.BigNumber
                    ? rawTx.gasLimit.toString()
                    : rawTx.gasLimit
                ),
                gasPrice: ethers_1.utils.bigNumberify(
                  rawTx.gasPrice instanceof bignumber_js_1.BigNumber
                    ? rawTx.gasPrice.toString()
                    : rawTx.gasPrice
                ),
                nonce: rawTx.nonce,
                to: rawTx.to,
                value: ethers_1.utils.bigNumberify(
                  rawTx.value instanceof bignumber_js_1.BigNumber
                    ? rawTx.value.toString()
                    : rawTx.value
                )
              })
            ]
          case 1:
            ...
            return [
              2 /*return*/,
              this.provider.sendSignedTransaction(signedTransaction)
            ]
        }
      })
    })
