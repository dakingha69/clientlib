...
var EthersWallet = /** @class */ (function () {
    ...
    EthersWallet.prototype.loadFrom = function (walletData) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                TLWallet_1.verifyWalletData(walletData, TLWallet_1.WALLET_TYPE_ETHERS, TLWallet_1.EXPECTED_VERSIONS);
                this.walletFromEthers = WalletFromEthers_1.WalletFromEthers.fromWalletData(walletData);
                return [2 /*return*/];
            });
        });
    };
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        _a = ethers_1.utils.splitSignature(flatFormatSignature), r = _a.r, s = _a.s, v = _a.v;
                        return [2 /*return*/, {
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.walletFromEthers.sign({
                                data: rawTx.data,
                                gasLimit: ethers_1.utils.bigNumberify(rawTx.gasLimit instanceof bignumber_js_1.BigNumber
                                    ? rawTx.gasLimit.toString()
                                    : rawTx.gasLimit),
                                gasPrice: ethers_1.utils.bigNumberify(rawTx.gasPrice instanceof bignumber_js_1.BigNumber
                                    ? rawTx.gasPrice.toString()
                                    : rawTx.gasPrice),
                                nonce: rawTx.nonce,
                                to: rawTx.to,
                                value: ethers_1.utils.bigNumberify(rawTx.value instanceof bignumber_js_1.BigNumber ? rawTx.value.toString() : rawTx.value)
                            })];
                    case 1:
