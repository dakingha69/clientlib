...
var IdentityWallet = /** @class */ (function() {
  ...
  IdentityWallet.prototype.getWalletData = function() {
    return __awaiter(this, void 0, void 0, function() {
      return __generator(this, function(_a) {
        ...
        return [
          2 /*return*/,
          this.walletFromEthers.toIdentityWalletData(this.identityAddress)
        ]
      })
    })
  }
      ...
      return __generator(this, function(_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.provider.fetchEndpoint('users/' + this.address + '/balance')
            ]
          case 1:
            balance = _a.sent()
            return [
  ...
  IdentityWallet.prototype.create = function() {
    return __awaiter(this, void 0, void 0, function() {
      ...
      return __generator(this, function(_a) {
        ...
        identityAddress = calculateIdentityAddress(
          this.identityFactoryAddress,
          walletFromEthers.address
        )
        return [
          2 /*return*/,
          walletFromEthers.toIdentityWalletData(identityAddress)
        ]
      })
    })
  }
  ...
  IdentityWallet.prototype.deployIdentity = function() {
    return __awaiter(this, void 0, void 0, function() {
      ...
      return __generator(this, function(_a) {
        switch (_a.label) {
          case 0:
            messageHash = ethers_1.utils.solidityKeccak256(
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              this.provider.postToEndpoint(deployIdentityEndpoint, {
      ...
      return __generator(this, function(_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.provider.fetchEndpoint('/identities/' + this.address)
            ]
          case 1:
            response = _a.sent()
          ...
          case 2:
            error_1 = _a.sent()
            if (
              error_1.message.includes('Status 404') &&
  ...
  IdentityWallet.prototype.loadFrom = function(walletData) {
    return __awaiter(this, void 0, void 0, function() {
      ...
      return __generator(this, function(_a) {
        TLWallet_1.verifyWalletData(
          walletData,
          TLWallet_1.WALLET_TYPE_IDENTITY,
          TLWallet_1.EXPECTED_VERSIONS
        )
        walletFromEthers = WalletFromEthers_1.WalletFromEthers.fromWalletData(
          walletData
        )
   ...
   */
  IdentityWallet.prototype.recoverFromEncryptedKeystore = function(
      ...
      return __generator(this, function(_a) {
        switch (_a.label) {
          case 0:
            return [
              4 /*yield*/,
              WalletFromEthers_1.WalletFromEthers.fromEncryptedJson(
                serializedEncryptedKeystore,
                password,
  ...
  IdentityWallet.prototype.recoverFromSeed = function(seed) {
    return __awaiter(this, void 0, void 0, function() {
      var walletFromEthers, identityAddress
      return __generator(this, function(_a) {
        walletFromEthers = WalletFromEthers_1.WalletFromEthers.fromMnemonic(
          seed
        )
        identityAddress = calculateIdentityAddress(
          this.identityFactoryAddress,
      ...
      return __generator(this, function(_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [
              2 /*return*/,
              this.provider.sendSignedMetaTransaction(metaTransaction)
            ]
        }
      })
    })
      ...
      return __generator(this, function(_b) {
        switch (_b.label) {
          case 0:
            ...
            metaTransactionHash = ethers_1.utils.solidityKeccak256(
              types,
              values
            )
            _a = metaTransaction
   ...
   */
  IdentityWallet.prototype.encryptToSerializedKeystore = function(
    walletData,
    password,
    progressCallback
  ) {
        ...
        switch (_c.label) {
          case 0:
            ...
            if (hash.length !== expectedHashLength) {
              throw new Error(
                'The input hash given is not a hash hex string prefixed with "0x": ' +
                  hash
              )
            }
            signingKey = new ethers_1.utils.SigningKey(
