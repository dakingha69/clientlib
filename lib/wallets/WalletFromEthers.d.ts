...
export declare class WalletFromEthers extends ethers.Wallet {
    static fromWalletData(walletData: EthersWalletData | IdentityWalletData): WalletFromEthers;
    static createRandom(): WalletFromEthers;
    static fromEncryptedJson(encryptedJson: string, password: string, progressCallback?: (progress: number) => any): Promise<WalletFromEthers>;
